...
var SDKLogger = class _SDKLogger {
  ...
  createLogger() {
    if (!this.config.enabled) {
      return pino__default.default({ level: "silent" });
    }
    const pinoOptions = {
    ...
    if (shouldUsePrettyPrint) {
      try {
        ...
        return pino__default.default(pinoOptions);
      } catch (error) {
...
exports.LOG_LEVEL_PRIORITIES = LOG_LEVEL_PRIORITIES;
...
//# sourceMappingURL=chunk-N5COKLPQ.js.map
//# sourceMappingURL=chunk-N5COKLPQ.js.map