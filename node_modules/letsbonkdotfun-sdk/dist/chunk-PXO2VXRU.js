...
var LETSBONK_PROGRAM_ID = new web3_js.PublicKey("LanMV9sAd7wArD4vJFi2qDdfnVhFxYSUg6eADduJ3uj");
var RAYDIUM_AUTHORITY = new web3_js.PublicKey("WLHv2UAZm6z4KyaaELi5pjdbJh6RESMva1Rnn8pJVVh");
var GLOBAL_CONFIG = new web3_js.PublicKey("6s1xP3hpbAfFoNtUNF8mfHsjr2Bd97JxFJRWLbL6aHuX");
var PLATFORM_CONFIG = new web3_js.PublicKey("FfYek5vEz23cMkWsdJwG2oa6EphsvXSHrGpdALN4g6W1");
var EVENT_AUTHORITY = new web3_js.PublicKey("2DPAtwB8L12vrMRExbLuyGnC7n2J5LNoZQSejeQGpwkr");
...
var SYSTEM_PROGRAM_ID = new web3_js.PublicKey("11111111111111111111111111111111");
var METAPLEX_PROGRAM = new web3_js.PublicKey("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s");
var RENT_SYSVAR = new web3_js.PublicKey("SysvarRent111111111111111111111111111111111");
var WSOL_TOKEN = new web3_js.PublicKey("So11111111111111111111111111111111111111112");
var PLATFORM_ADMIN = new web3_js.PublicKey("2P56vRWDrCBGkqYXxgSWAnuZQZrJPySRQGToTJThpmkN");
...
var VAULT_AUTH_SEED = buffer.Buffer.from("vault_auth_seed");
var EVENT_AUTHORITY_SEED = buffer.Buffer.from("__event_authority");
var GLOBAL_CONFIG_SEED = buffer.Buffer.from("global_config");
var PLATFORM_CONFIG_SEED = buffer.Buffer.from("platform_config");
var POOL_SEED = buffer.Buffer.from("pool");
var POOL_VAULT_SEED = buffer.Buffer.from("pool_vault");
var POOL_VESTING_SEED = buffer.Buffer.from("pool_vesting");
var METADATA_SEED = buffer.Buffer.from("metadata");
var PDA_SEEDS = {
...
var BaseManager = class {
  ...
  async executeOperation(operationName, operation, errorMapper, context) {
    ...
    try {
      ...
      const result = await chunkN5COKLPQ_js.tryAsync(operation(), errorMapper);
      if (result.success) {
...
var PDAUtils = class _PDAUtils {
  ...
  static findVaultAuthority(programId = _PDAUtils.DEFAULT_PROGRAM_ID) {
    return web3_js.PublicKey.findProgramAddressSync([VAULT_AUTH_SEED], programId);
  }
  /**
  ...
  static findEventAuthority(programId = _PDAUtils.DEFAULT_PROGRAM_ID) {
    return web3_js.PublicKey.findProgramAddressSync([EVENT_AUTHORITY_SEED], programId);
  }
  /**
...
var SharedValidators = class _SharedValidators {
  ...
  static validatePublicKey(key, fieldName) {
    if (!key) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} is required`, fieldName, key));
    }
    try {
      key.toString();
      return chunkN5COKLPQ_js.success(void 0);
    } catch {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`Invalid ${fieldName}`, fieldName, key));
    }
  }
  /**
   * Validate Keypair
  ...
  static validateKeypair(keypair, fieldName) {
    if (!keypair) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} keypair is required`, fieldName, keypair));
    }
    if (!keypair.publicKey || !keypair.secretKey) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`Invalid ${fieldName} keypair`, fieldName, keypair));
    }
    return chunkN5COKLPQ_js.success(void 0);
  }
  /**
  ...
  static validateString(value, fieldName, minLength = 1, maxLength = 1e3) {
    if (!value || typeof value !== "string") {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} is required`, fieldName, value));
    }
    const trimmed = value.trim();
    if (trimmed.length < minLength) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError(
  ...
  static validateBigIntAmount(amount, fieldName, minAmount = 0n) {
    if (amount === void 0 || amount === null) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} is required`, fieldName, amount));
    }
    if (typeof amount !== "bigint") {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} must be a bigint`, fieldName, amount));
    }
    if (amount < minAmount) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError(`${fieldName} must be at least ${minAmount}`, fieldName, amount)
      );
    }
    return chunkN5COKLPQ_js.success(void 0);
  }
  ...
  static validateURL(url, fieldName, required = false) {
    if (!url) {
      if (required) {
        return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} is required`, fieldName, url));
      }
      return chunkN5COKLPQ_js.success(void 0);
    }
    try {
      ...
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`Invalid ${fieldName} URL`, fieldName, url));
    }
  }
  /**
   * Validate file blob
  ...
  static validateFile(file, fieldName, maxSizeBytes = 10 * 1024 * 1024) {
    if (!file) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} is required`, fieldName, file));
    }
    if (!(file instanceof Blob)) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} must be a Blob`, fieldName, file));
    }
    if (file.size === 0) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError(`${fieldName} cannot be empty`, fieldName, file));
    }
  ...
  static validateInitializeParams(params) {
    ...
    if (!params.tokenMetadata) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError("Token metadata is required", "tokenMetadata", params.tokenMetadata)
      );
    }
...
function isValidPublicKey(key) {
  return !key.equals(web3_js.SystemProgram.programId);
}
...
var AccountManager = class {
  ...
  async getGlobalConfig(quoteMint = WSOL_TOKEN, curveType = 0, index = 0) {
    ...
    try {
      ...
      const result = await chunkN5COKLPQ_js.tryAsync(
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        this.program.account.globalConfig.fetch(globalConfigPDA),
        (error) => new chunkN5COKLPQ_js.AccountError(
      ...
      if (!result.success) {
        ...
        return chunkN5COKLPQ_js.failure(result.error);
      }
      ...
      timer.end({ success: true });
      return chunkN5COKLPQ_js.success(globalConfig);
    } catch (error) {
      const accountError = new chunkN5COKLPQ_js.AccountError(
      ...
      return chunkN5COKLPQ_js.failure(accountError);
    }
  }
  /**
  ...
  async getPlatformConfig(platformAdmin, index = 0) {
    ...
    try {
      ...
      timer.end({ success: true });
      return chunkN5COKLPQ_js.success(platformConfig);
    } catch (error) {
      const accountError = new chunkN5COKLPQ_js.AccountError(
  ...
  async getPoolState(baseMint, quoteMint = WSOL_TOKEN) {
    ...
    try {
      if (!isValidPublicKey(baseMint)) {
        const validationError = new chunkN5COKLPQ_js.ValidationError(
          "Invalid base mint provided",
          "baseMint",
          baseMint
        );
        this.logger.error("Invalid base mint", { baseMint: baseMint.toString() });
        return chunkN5COKLPQ_js.failure(validationError);
      }
      ...
      if (!result.success) {
        if (result.error.message.includes("Account does not exist")) {
          ...
          return chunkN5COKLPQ_js.success(null);
        }
      ...
      return chunkN5COKLPQ_js.success(poolState);
    } catch (error) {
      const accountError = new chunkN5COKLPQ_js.AccountError(
  ...
  async poolExists(baseMint, quoteMint = WSOL_TOKEN) {
    ...
    return chunkN5COKLPQ_js.success(result.data !== null);
  }
  /**
  ...
  async getMultipleAccountStates(requests) {
    ...
    try {
      ...
      timer.end({ success: true });
      return chunkN5COKLPQ_js.success(results);
    } catch (error) {
      const accountError = new chunkN5COKLPQ_js.AccountError(
...
function getAltAccountPublicKey() {
  return new web3_js.PublicKey(ALT_ACCOUNT_ADDRESS);
}
...
async function setupV0Transaction(connection, payer, instructions, priorityFees) {
  ...
  const computeBudgetInstructions = [
    ...
    new web3_js.TransactionInstruction({
      keys: [],
      programId: new web3_js.PublicKey("ComputeBudget111111111111111111111111111111"),
      data: Buffer.concat([
        Buffer.from([3]),
...
async function createOrGetTokenAccount(connection, owner, mint) {
  try {
    const tokenAccount = await splToken.getAssociatedTokenAddress(mint, owner);
...
async function createTemporaryWSOLAccount(connection, payer, amount) {
  ...
  const wsolAccount = await web3_js.PublicKey.createWithSeed(payer, seed, TOKEN_PROGRAM_ID);
  ...
  const instructions = [
    ...
    web3_js.SystemProgram.createAccountWithSeed({
      fromPubkey: payer,
      basePubkey: payer,
      seed,
    ...
    splToken.createInitializeAccountInstruction(wsolAccount, WSOL_TOKEN, payer)
  ];
  return { address: wsolAccount, instructions, keypair: void 0 };
}
function getCloseWSOLInstruction(wsolAccount, owner) {
  return splToken.createCloseAccountInstruction(wsolAccount, owner, owner);
}
...
var logger = chunkN5COKLPQ_js.getLogger();
...
async function createAnchorInitializeInstruction(connection, payer, creator, baseMint, metadataUri, name, symbol, decimals = 6, supply = DEFAULT_SUPPLY, baseSell = DEFAULT_BASE_SELL, quoteRaising = DEFAULT_QUOTE_RAISING) {
  ...
  const program = new anchor.Program(letsbonk_default, provider);
  ...
  const curveParam = {
    constant: {
      data: {
        supply: new bn_js.BN(supply),
        totalBaseSell: new bn_js.BN(baseSell),
        totalQuoteFundRaising: new bn_js.BN(quoteRaising),
        migrateType: 1
      }
    }
  };
  const vestingParam = {
    totalLockedAmount: new bn_js.BN(0),
    cliffPeriod: new bn_js.BN(0),
    unlockPeriod: new bn_js.BN(0)
  };
  return await program.methods.initialize(baseMintParam, curveParam, vestingParam).accountsPartial({
    ...
    baseTokenProgram: splToken.TOKEN_PROGRAM_ID,
...
var logger2 = chunkN5COKLPQ_js.getLogger();
...
var logger3 = chunkN5COKLPQ_js.getLogger();
...
var TransactionManager = class {
  ...
  async buildBuy(params) {
    ...
    try {
      ...
      if (!validation.success) {
        return chunkN5COKLPQ_js.failure(validation.error);
      }
      const buildResult = await chunkN5COKLPQ_js.tryAsync(
        buildBuyTransaction(
          this.connection,
          params.buyer,
          params.baseMint,
        ...
        (error) => new chunkN5COKLPQ_js.TransactionError(
      ...
      if (!buildResult.success) {
        ...
        return chunkN5COKLPQ_js.failure(buildResult.error);
      }
      ...
      return chunkN5COKLPQ_js.success(constructedTransaction);
    } catch (error) {
      const txError = new chunkN5COKLPQ_js.TransactionError(
      ...
      return chunkN5COKLPQ_js.failure(txError);
    }
  }
  /**
  ...
  async execute(constructedTransaction, options = {}) {
    ...
    try {
      ...
      const executeResult = await chunkN5COKLPQ_js.tryAsync(
        Promise.race([
        ...
        (error) => {
          if (error.message.includes("timeout")) {
            return new chunkN5COKLPQ_js.TimeoutError("Transaction execution timed out", timeout, operation, error);
          }
          return new chunkN5COKLPQ_js.TransactionError(
      ...
      if (!executeResult.success) {
        ...
        return chunkN5COKLPQ_js.failure(executeResult.error);
      }
      ...
      return chunkN5COKLPQ_js.success(result);
    } catch (error) {
      const txError = new chunkN5COKLPQ_js.TransactionError(
  ...
  async buildInitializeAndBuy(payer, creator, baseMint, tokenMetadata, buyAmountLamports, priorityFees) {
    ...
    try {
      ...
      const buildResult = await chunkN5COKLPQ_js.tryAsync(
        ...
        (error) => new chunkN5COKLPQ_js.ValidationError(
      ...
      const txError = new chunkN5COKLPQ_js.ValidationError(
...
var MetadataManager = class {
  ...
  async uploadMetadata(metadata) {
    ...
    try {
      ...
      const uploadResult = await chunkN5COKLPQ_js.tryAsync(
        uploadTokenMetadata(metadata),
        (error) => new chunkN5COKLPQ_js.NetworkError(`Failed to upload metadata: ${error.message}`, "ipfs", void 0, error)
      );
      if (!uploadResult.success) {
        timer.end({ success: false, error: uploadResult.error.message });
        return chunkN5COKLPQ_js.failure(uploadResult.error);
      }
      ...
      const networkError = new chunkN5COKLPQ_js.NetworkError(
      ...
      return chunkN5COKLPQ_js.failure(networkError);
    }
  }
  /**
  ...
  async prepareMetadata(params) {
    ...
    try {
      ...
      timer.end({ success: true });
      return chunkN5COKLPQ_js.success(result.data);
    } catch (error) {
      const validationError = new chunkN5COKLPQ_js.ValidationError(
  ...
  createImageFromBase64(base64) {
    try {
      ...
      return chunkN5COKLPQ_js.success(blob);
    } catch (error) {
      const validationError = new chunkN5COKLPQ_js.ValidationError(
  ...
  async buildImageFromUrl(url) {
    ...
    try {
      ...
      try {
        ...
        return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError("Invalid URL provided", "url", url));
      }
      const result = await chunkN5COKLPQ_js.tryAsync(
        createImageBlobFromUrl(url),
        (error) => new chunkN5COKLPQ_js.NetworkError(
  ...
  validateMetadata(metadata) {
    if (!metadata.name || metadata.name.trim().length === 0) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError("Token name is required", "name", metadata.name));
    }
    if (!metadata.symbol || metadata.symbol.trim().length === 0) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError("Token symbol is required", "symbol", metadata.symbol));
    }
    if (!metadata.description || metadata.description.trim().length === 0) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError("Token description is required", "description", metadata.description)
      );
    }
    if (!metadata.file) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError("Token image file is required", "file", metadata.file));
    }
    if (metadata.symbol.length > 10) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError("Token symbol must be 10 characters or less", "symbol", metadata.symbol)
      );
    }
    ...
    if (metadata.file.size > 1024 * 1024) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError("Image file must be smaller than 1MB", "file", metadata.file)
      );
    }
    return chunkN5COKLPQ_js.success(void 0);
  }
  ...
  validatePreparationParams(params) {
    if (!params.name || params.name.trim().length === 0) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError("Token name is required", "name", params.name));
    }
    if (!params.symbol || params.symbol.trim().length === 0) {
      return chunkN5COKLPQ_js.failure(new chunkN5COKLPQ_js.ValidationError("Token symbol is required", "symbol", params.symbol));
    }
    if (!params.description || params.description.trim().length === 0) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError("Token description is required", "description", params.description)
      );
    }
    if (!params.imageInput) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError("Image input is required", "imageInput", params.imageInput)
      );
    }
    if (params.symbol.length > 10) {
      return chunkN5COKLPQ_js.failure(
        new chunkN5COKLPQ_js.ValidationError("Token symbol must be 10 characters or less", "symbol", params.symbol)
      );
    }
...
exports.ALT_ACCOUNT_ADDRESS = ALT_ACCOUNT_ADDRESS;
exports.ASSOCIATED_TOKEN_PROGRAM_ID = ASSOCIATED_TOKEN_PROGRAM_ID;
exports.AccountManager = AccountManager;
exports.BUY_EXACT_IN_DISCRIMINATOR = BUY_EXACT_IN_DISCRIMINATOR;
exports.BaseManager = BaseManager;
exports.DEFAULT_BASE_SELL = DEFAULT_BASE_SELL;
exports.DEFAULT_COMMITMENT = DEFAULT_COMMITMENT;
exports.DEFAULT_FINALITY = DEFAULT_FINALITY;
exports.DEFAULT_MAX_RETRIES = DEFAULT_MAX_RETRIES;
exports.DEFAULT_QUOTE_RAISING = DEFAULT_QUOTE_RAISING;
exports.DEFAULT_SHARE_FEE_RATE = DEFAULT_SHARE_FEE_RATE;
exports.DEFAULT_SLIPPAGE_BASIS_POINTS = DEFAULT_SLIPPAGE_BASIS_POINTS;
exports.DEFAULT_SUPPLY = DEFAULT_SUPPLY;
exports.DEFAULT_TIMEOUT_MS = DEFAULT_TIMEOUT_MS;
exports.EVENT_AUTHORITY = EVENT_AUTHORITY;
...
exports.GLOBAL_CONFIG_SIZE = GLOBAL_CONFIG_SIZE;
exports.INITIALIZE_DISCRIMINATOR = INITIALIZE_DISCRIMINATOR;
exports.LETSBONK_PROGRAM_ID = LETSBONK_PROGRAM_ID;
exports.METADATA_SEED = METADATA_SEED;
exports.METAPLEX_PROGRAM = METAPLEX_PROGRAM;
exports.MetadataManager = MetadataManager;
exports.PDAUtils = PDAUtils;
exports.PDA_SEEDS = PDA_SEEDS;
exports.PLATFORM_ADMIN = PLATFORM_ADMIN;
exports.PLATFORM_CONFIG = PLATFORM_CONFIG;
exports.PLATFORM_CONFIG_SEED = PLATFORM_CONFIG_SEED;
exports.PLATFORM_CONFIG_SIZE = PLATFORM_CONFIG_SIZE;
exports.POOL_SEED = POOL_SEED;
exports.POOL_STATE_SIZE = POOL_STATE_SIZE;
exports.POOL_VAULT_SEED = POOL_VAULT_SEED;
exports.POOL_VESTING_SEED = POOL_VESTING_SEED;
exports.PoolManager = PoolManager;
exports.RAYDIUM_AUTHORITY = RAYDIUM_AUTHORITY;
exports.RENT_SYSVAR = RENT_SYSVAR;
exports.SDK_NAME = SDK_NAME;
exports.SDK_VERSION = SDK_VERSION;
exports.SELL_EXACT_IN_DISCRIMINATOR = SELL_EXACT_IN_DISCRIMINATOR;
exports.SOL_DECIMAL = SOL_DECIMAL;
...
exports.UNIT_BUDGET = UNIT_BUDGET;
exports.UNIT_PRICE = UNIT_PRICE;
exports.VAULT_AUTH_SEED = VAULT_AUTH_SEED;
exports.WSOL_TOKEN = WSOL_TOKEN;
...
exports.buildInitializeAndBuyTransaction = buildInitializeAndBuyTransaction;
exports.buildLaunchInstruction = buildLaunchInstruction;
...
exports.calculateTokensReceive = calculateTokensReceive;
exports.createAnchorInitializeInstruction = createAnchorInitializeInstruction;
exports.createImageBlob = createImageBlob;
exports.createImageBlobFromUrl = createImageBlobFromUrl;
exports.createOrGetTokenAccount = createOrGetTokenAccount;
exports.createTemporaryWSOLAccount = createTemporaryWSOLAccount;
exports.fetchAltAccount = fetchAltAccount;
exports.getAltAccountPublicKey = getAltAccountPublicKey;
exports.getCloseWSOLInstruction = getCloseWSOLInstruction;
exports.isValidPublicKey = isValidPublicKey;
exports.letsbonk_default = letsbonk_default;
exports.orchestrateTokenLaunch = orchestrateTokenLaunch;
...
exports.setupV0Transaction = setupV0Transaction;
exports.uploadTokenMetadata = uploadTokenMetadata;
//# sourceMappingURL=chunk-PXO2VXRU.js.map
//# sourceMappingURL=chunk-PXO2VXRU.js.map