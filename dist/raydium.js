...
class Raydium {
    ...
    async extractDeveloperFromTransaction(signature) {
        try {
            ...
            for (const accountStr of allAccounts) {
                const account = new web3_js_1.PublicKey(accountStr);
                if (!this.isKnownProgramId(account) && !this.isSystemAccount(account)) {
    ...
    isKnownProgramId(pubkey) {
        const knownPrograms = [
            ...
            new web3_js_1.PublicKey('11111111111111111111111111111112'), // System Program
            new web3_js_1.PublicKey('TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA'), // Token Program
            new web3_js_1.PublicKey('ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL'), // Associated Token Program
        ];
    ...
    isSystemAccount(pubkey) {
        const systemAccounts = [
            new web3_js_1.PublicKey('11111111111111111111111111111111'), // Default/null PublicKey
            new web3_js_1.PublicKey('So11111111111111111111111111111111111111112'), // WSOL mint
            new web3_js_1.PublicKey('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v'), // USDC mint
            new web3_js_1.PublicKey('Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB'), // USDT mint
